    ...
    <div className="container mx-auto">
      ...
      {audioParts.length > 1 && (
        <motion.div
          ...
          className="mb-2 flex flex-row items-center justify-center gap-2 rounded-lg bg-gray-50 p-3 shadow-inner"
        >
          {/* Flèche Gauche */}
          <motion.button
      ...
      >
        ...
        >
          <div className="sticky top-[-10px] z-20 flex w-full items-center justify-center border-b border-gray-100 bg-gradient-to-r from-yellow-300 via-yellow-400 to-yellow-500/80 py-6 text-center text-gray-800 shadow backdrop-blur-lg md:min-h-[3.8rem] md:text-5xl">
            <h1 className="font-quran absolute z-30 flex h-full w-full items-center justify-center">
              <div className="mx-auto flex h-4/5 min-h-0 w-fit max-w-3xl items-center justify-center rounded-2xl bg-white/90 px-4 py-2 shadow md:px-8">
                <span
